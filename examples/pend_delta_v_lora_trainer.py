...
This modifies V_net's internal feature computation rather than adding
an output-space correction (as delta_V_net does).

Usage:
    python examples/pend_delta_v_lora_trainer.py \
        ...
        --max_epochs 1000 --lora_rank 4 --lora_alpha 1.0
"""
...
class DeltaVLoRAModel(pl.LightningModule):
    ...
    def _load_and_freeze(self, ckpt_path):
        ...
        LoRA layers are already applied in __init__, so here we only need to
        copy pretrained weights into the frozen base weight slots of LoRALinear.
        """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='pend-delta-v-lora', type=str)
