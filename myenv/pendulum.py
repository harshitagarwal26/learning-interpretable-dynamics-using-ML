...
class PendulumEnv(gym.Env):
    ...
    def dynamics(self, t, y, u):
        ...
        # f[1] = (-3*g/(2*l) * np.sin(y[0]))
        eta1 = -0.0481   # N*m/rad
        eta2 = 0.0113   # N*m/rad^2
        eta3 = 0.1125   # N*m/rad^3
        alpha1 = 3*eta1/(m*l**2)
        alpha2 = 3*eta2/(m*l**2)
        alpha3 = 3*eta3/(m*l**2)
